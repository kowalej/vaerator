...
namespace Vaerator.Controls
{
    ...
    public class ImageButton : Button
    {
        ...
        /// </summary>
        public static readonly BindableProperty SourceProperty = BindablePropertyExtension.Create(
        ...
        /// </summary>
        public static readonly BindableProperty DisabledSourceProperty = BindablePropertyExtension.Create(
        ...
        public static readonly BindableProperty OrientationProperty =
            BindablePropertyExtension.Create<ImageButton, ImageOrientation>(
        ...
        public static readonly BindableProperty ImageTintColorProperty =
            BindablePropertyExtension.Create<ImageButton, Color>(
